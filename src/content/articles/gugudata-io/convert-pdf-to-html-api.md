---
title: "Convert PDF to HTML API Documentation"
description: "Convert PDF to HTML API documentation with endpoint details, request parameters, response fields, HTTP status codes, and integration examples for developers."
section: "gugudata-io"
...
author: "GuGuData"
---
## Convert PDF to HTML API: Technical Guide and Integration Notes
...
This article is written for developers who want a crawlable, readable reference before integrating the endpoint into a product, data pipeline, internal tool, or technical workflow. The official detail page is [https://gugudata.io/details/pdf2html](https://gugudata.io/details/pdf2html).
...
```bash
curl -X POST "https://api.gugudata.io/v1/imagerecognition/pdf2html?appkey=REDACTED \
  -F "file=@./sample.pdf"
```
