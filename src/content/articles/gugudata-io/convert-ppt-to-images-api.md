---
title: "Convert PPT to Images API Documentation"
description: "Convert PPT to Images API documentation with endpoint details, request parameters, response fields, HTTP status codes, and integration examples for developers."
section: "gugudata-io"
...
author: "GuGuData"
---
## Convert PPT to Images API: Technical Guide and Integration Notes
...
This article is written for developers who want a crawlable, readable reference before integrating the endpoint into a product, data pipeline, internal tool, or technical workflow. The official detail page is [https://gugudata.io/details/ppt2images](https://gugudata.io/details/ppt2images).
...
```bash
curl -X POST "https://api.gugudata.io/v1/imagerecognition/ppt-to-images?appkey=REDACTED \
  -F "file=@./sample.pptx" \
  -F "scale_factor=1"
```
