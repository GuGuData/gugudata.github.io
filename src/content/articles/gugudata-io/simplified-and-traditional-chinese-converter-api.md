---
title: "Simplified and Traditional Chinese Converter API Documentation"
description: "Simplified and Traditional Chinese Converter API documentation with endpoint details, request parameters, response fields, HTTP status codes, and integration e…"
section: "gugudata-io"
...
author: "GuGuData"
---
## Simplified and Traditional Chinese Converter API: Technical Guide and Integration Notes
...
This article is written for developers who want a crawlable, readable reference before integrating the endpoint into a product, data pipeline, internal tool, or technical workflow. The official detail page is [https://gugudata.io/details/stconvert](https://gugudata.io/details/stconvert).
...
```bash
curl -X POST "https://api.gugudata.io/v1/text/stconvert?appkey=REDACTED \
