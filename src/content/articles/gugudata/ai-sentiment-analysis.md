---
title: "多语言文本 AI 情感分析 API 接口"
description: "接口详情官网地址: https://www.gugudata.com/api/details/sentiment-analysis"
section: "gugudata"
...
**接口地址:** https://api.gugudata.com/ai/sentiment-analysis?appkey=REDACTED&streaming={{streaming}}
...
**请求示例:** https://api.gugudata.com/ai/sentiment-analysis?appkey=REDACTED&streaming=false&textContent=YOUR_VALUE
...
| --- | --- | --- | --- | --- |
| textContent | string | 是 | YOUR_VALUE | 需要进行情感分析的文本内容 |
...
- 适合用于内容生成与智能处理，快速补齐产品侧需要的 多语言文本 AI 情感分析 数据能力。
