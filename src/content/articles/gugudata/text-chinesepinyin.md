---
title: "中文转拼音 API 接口"
description: "接口详情官网地址: https://www.gugudata.com/api/details/chinesepinyin"
section: "gugudata"
slug: "text-chinesepinyin"
lang: "zh-CN"
status: "published"
tags: ["API","GuGuData"]
...
**接口地址:** https://api.gugudata.com/text/chinesepinyin
...
**请求示例:** https://api.gugudata.com/text/chinesepinyin?appkey=REDACTED&content=YOUR_VALUE

**数据预览:** [https://www.gugudata.com/preview/chinesepinyin](https://www.gugudata.com/preview/chinesepinyin)

**接口测试:** [https://api.gugudata.com/text/chinesepinyin/demo](https://api.gugudata.com/text/chinesepinyin/demo)
...
| content | string | 是 | YOUR_VALUE | 需要转拼音的中文文本 |
...
- 适合用于中文文本处理与内容清洗，快速补齐产品侧需要的 中文转拼音 数据能力。
