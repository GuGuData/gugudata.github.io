---
title: "NLP 关键字摘要智能提取 API 接口"
description: "接口详情官网地址: https://www.gugudata.com/api/details/nlpabstract"
section: "gugudata"
slug: "text-nlpabstract"
lang: "zh-CN"
status: "published"
tags: ["API","GuGuData"]
...
**接口地址:** https://api.gugudata.com/text/nlpabstract
...
**请求示例:** https://api.gugudata.com/text/nlpabstract?appkey=REDACTED&content=YOUR_VALUE

**数据预览:** [https://www.gugudata.com/preview/nlpabstract](https://www.gugudata.com/preview/nlpabstract)

**接口测试:** [https://api.gugudata.com/text/nlpabstract/demo](https://api.gugudata.com/text/nlpabstract/demo)
...
| content | string | 是 | YOUR_VALUE | 内容正文 |
...
| Data.ListAbstractKeywords.Word | string[] | 提取的关键字，最多 5 个 |
| Data.ListAbstractSummary.Sentence | string[] | 提取的摘要，最多 5 条 |
...
- 适合用于中文文本处理与内容清洗，快速补齐产品侧需要的 NLP 关键字摘要智能提取 数据能力。
