...
cover: "https://devopenclub.parryqiu.com/blog_04004445-a54496109c9c4cd48ac076e964970095.png"
author: "Parry Qiu"
---
...
针对测试https://oindk07nf.qnssl.com所以选择程序文件夹下 \bin\Debug\ 里面的exe 即可。
在 Profiling Mode 里可以选择监控的级别，基本就是监控信息的多少与速度的权衡，默认选择「最详细」即可。其他的详细设置可以参考帮助文档。
点击「Start Profiling」，启动程序。

![](https://devopenclub.parryqiu.com/blog_04004445-a54496109c9c4cd48ac076e964970095.png)
...
![](https://devopenclub.parryqiu.com/blog_04013041-047c2d611a9b40f2a23d565ba9188600.png)

选定后可以立即在下面的结果窗口中看到最耗时的方法，比如上面的 DEMO，当然性能都消耗在了 Main 函数上。

![](https://devopenclub.parryqiu.com/blog_04010702-f26964d269fd460c9b4d7f2efd8b318e.png)

软件提供了多种度量值查看性能损耗，有百分比和多种时间格式，这里选定「秒」作为度量单位。

![](https://devopenclub.parryqiu.com/blog_04010406-5c56945085004b5db38819194725e5a9.png)

再选择要查看的函数，软件强大之处就显现出来了。

*   右侧的红色标线，点击可以快速定位到最耗能的代码，颜色越深表示那段代码越耗能。
*   https://oindk07nf.qnssl.com总的执行时间，当然还可以同时看到代码供分析使用。

至于 DEMO 里这段代码为什么第一次执行 Console.WriteLine 如此耗能，我想如果你认真看了《CLR via C#》的第一章就应该能知道答案了。

![](https://devopenclub.parryqiu.com/blog_04011025-45c8dd61d1b84d198368361bd69b8412.png)

当然你还https://oindk07nf.qnssl.com
这样的层次结构图还有一个好处就是可以看到 .NET Framework 的内部实现。
当进行一些决策，比如是用原生的功能还是第三方组件时，这个功能会变得非常好用，因为通过它能比较直观的地看到内部实现的性能瓶颈在哪里。

![](https://devopenclub.parryqiu.com/blog_04011515-580e6561e44a490a92f74419fb8d284d.png)
