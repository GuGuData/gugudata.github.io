...
cover: "https://devopenclub.parryqiu.com/blog_gzip_1.jpg"
author: "Parry Qiu"
---
...
![](https://devopenclub.parryqiu.com/blog_gzip_6.jpg)\

 * 使https://oindk07nf.qnssl.cometaBase.xml(建议先备份),找到Location ="/LM/W3SVC/Filters/Compression/gzip用于设置gzip压缩，找到Location ="/LM/W3SVC/Filters/Compression/deflate"用于设置deflate压缩。上面两个节点紧挨着，并且设置的属性相同。
...
![](https://devopenclub.parryqiu.com/blog_gzip_7.jpg)\
