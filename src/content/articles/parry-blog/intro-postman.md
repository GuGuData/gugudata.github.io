---
title: "数据接口测试工具 Postman 介绍"
description: "此文介绍好用的数据接口测试工具 Postman,能帮助您方便、快速、统一地管理项目中使用以及测试的数据接口。"
section: "parry-blog"
slug: "intro-postman"
lang: "zh-CN"
status: "archived"
...
## 1. Postman 简介
> Postman 一款非常流行的 API 调试工具。其实，开发人员用的更多。因为测试人员做接口测试会有更多选择，例如 Jmeter、soapUI 等。
> 不过，对于开发过程中去调试接口，Postman 确实足够的简单方便，而且功能强大。

在我给大家录制分享的很多系列课程中，凡是涉及到接口演示与讲解的部分，都会使用 Postman 进行演示，如最近在知识星球里分享给大家的开放数据接口，演示的部分就是使用的 Postman 进行的接口的管理与调用演示。
...
所有平台下载地址：[https://www.getpostman.com/apps](https://www.getpostman.com/apps)
