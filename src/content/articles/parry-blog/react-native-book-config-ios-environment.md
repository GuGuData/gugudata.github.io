...
1. 打开 App Store 搜索 Xcode，点击安装后等待下载完毕并自动完成安装，如图 5-1 所示。
 ...
 ![截图](https://devopenclub.parryqiu.com/b_4f65fe8000293cc157e8f7f1a81f1e64.png)
图 5-1 Xcode 的安装
...
2. 使用 Xcode 打开项目，这里我们直接打开课程配套源码文件夹中的 02-02-02 文件夹，此项目为本书第二章中建立的初始化项目，找到文件夹中的 /HelloReact/ios/HelloReact.xcodeproj 打开，xcodeproj 后缀的文件为 Xcode 的项目文件，如图 5-2 所示。
 ...
 ![截图](https://devopenclub.parryqiu.com/b_9ef6b7f388bccc79d25ffe79d7a81afd.png)
...
在 JavaScript 打包完成后，模拟器会自动启动并自动运行对应的 App，如图 5-4 所示。
 ...
 ![截图](https://devopenclub.parryqiu.com/b_3a7421a9d8d281c5e4babe006072b293.png)
图 5-3 React Packager 控制台

 ![截图](https://devopenclub.parryqiu.com/b_8cbabdbe77d44cb38cdf712be66abbd3.png)
图 5-4 选择模拟器并运行项目

4.	iOS App 启动后的效果如图 5-5 所示。

 ![截图](https://devopenclub.parryqiu.com/b_327f2cc3ec360734254988c1e273d8a3.png)
图 5-5 iOS 项目启动效果
...
![截图](https://devopenclub.parryqiu.com/b_8362a83bc65290bd43f93c17defbd6a8.png)
图 5-6 React Packager 自动重新打包

 ![截图](https://devopenclub.parryqiu.com/b_b666c12c0265c296bfc699019af9eeac.png)
图 5-7 App 界面自动刷新
...
![截图](https://devopenclub.parryqiu.com/b_ae34ab572c511665269bd19b2994a8ec.png)
图 5-8 导入 Android 项目

3.在导入 Android 项目后，Android Studio 会自动加载对应版本的 Gradle 进行项目的构建，此过程根据你的网络状况，可能耗时较长。项目自动构建完成后，如图 5-9 所示。

![截图](https://devopenclub.parryqiu.com/b_d661178efc9c3a168acdd5f710f708c1.png)
...
![截图](https://devopenclub.parryqiu.com/b_7bfc613ef43930d659c12725ea6ef459.png)
图 5-10 Android 环境下的 React Packager

![截图](https://devopenclub.parryqiu.com/b_890bafefb7ab2e81a0804f3b68f83cd0.png)
