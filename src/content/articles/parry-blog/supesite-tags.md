...
cover: "https://devopenclub.parryqiu.com/blog_SupeSite_1.png"
author: "Parry Qiu"
---
...
<fonhttps://oindk07nf.qnssl.com查询条件，作为标签数据源，模板引擎解析后在页面显示。\

## SupeSite已经做成了向导模式，选择“资讯”

![](https://devopenclub.parryqiu.com/blog_SupeSite_1.png)
https://oindk07nf.qnssl.com
## 生成block
代码如下，注意其中的cachename，即数据源名称，很显然，SupeSite对其做了cache，可以在cache设置中配置更新时间间隔。而name为唯一标识。

![](https://devopenclub.parryqiu.com/blog_SupeSite_2.png)

## 页面中的调用

![](https://devopenclub.parryqiu.com/blog_SupeSite_3.png)
